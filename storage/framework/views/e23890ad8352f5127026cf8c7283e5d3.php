...
<body class="sidebar-mini layout-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <!-- /.content-wrapper -->
        <?php if ($__env->exists('layouts.partials.footer')) echo $__env->make('layouts.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $component = App\View\Components\Toast::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('toast'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Toast::class))->getConstructor()): ?>
...
<?php /**PATH D:\WEB PROJEK\laravel-bengkel\resources\views/layouts/app.blade.php ENDPATH**/ ?>