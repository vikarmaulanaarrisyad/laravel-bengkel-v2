...
<body>
    ...
    <header>
        <!-- TOP HEADER -->
        <?php echo $__env->make('frontend.topheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /TOP HEADER -->

        <!-- MAIN HEADER -->
        <?php echo $__env->make('frontend.mainheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /MAIN HEADER -->
    </header>
    <!-- /HEADER -->

    <!-- NAVIGATION -->
    <?php echo $__env->make('frontend.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- /NAVIGATION -->
...
<?php /**PATH D:\WEB PROJEK\laravel-bengkel\resources\views/layouts/front.blade.php ENDPATH**/ ?>