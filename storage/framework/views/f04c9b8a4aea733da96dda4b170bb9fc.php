                    ...
                    <div class="col-md-7">
                        ...
                        <div class="billing-details">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" class="input form-control" cols="30" rows="3"
                        ...
                        <div class="order-notes">
                            ...
                            <textarea name="notes" class="input form-control" cols="30" rows="5"
            ...
            $('#districts, #courier').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.status === 'success' && Array.isArray(res.data) && res.data
                            .length > 0) {
                            res.data.forEach(function(
                                layanan) { // Langsung loop ke setiap objek layanan
                                let harga = layanan.cost;
                                let etd = layanan.etd;
                                let namaLayanan = layanan.service;
                                let kodeKurir = layanan.code.toUpperCase();
                                let text =
                                    `${kodeKurir} - ${namaLayanan} (${formatRupiah(harga, 'Rp. ')}) (ETD: ${etd})`;
                            ...
                            $('#service').html(
                                '<option disabled selected>Tidak ada layanan tersedia</option>'
                            );
                        }
                    },
                    error: function(xhr) {
                        ...
                        $('#service').html(
                            '<option disabled selected>Gagal memuat layanan</option>');
                    }
                });
            });
