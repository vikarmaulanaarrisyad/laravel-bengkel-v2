...
<div class="modal fade" id="resiModal" tabindex="-1" role="dialog" aria-labelledby="resiModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="resiForm" method="POST" action="<?php echo e(route('orders.update.resi')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Lenovo\Downloads\laravel-bengkel-v2\resources\views\orders\resi.blade.php ENDPATH**/ ?>