...
<?php $component->withAttributes([]); ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Category Store')): ?>
                     <?php $__env->slot('header', null, []); ?> 
                        <button onclick="addForm(`<?php echo e(route('category.store')); ?>`)" class="btn btn-sm btn-primary"><i
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Downloads\laravel-bengkel-v2\resources\views\category\index.blade.php ENDPATH**/ ?>