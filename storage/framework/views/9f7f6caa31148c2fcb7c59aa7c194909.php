...
<body>
    ...
    <header>
        <!-- TOP HEADER -->
        <?php echo $__env->make('frontend.topheader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!-- /TOP HEADER -->

        <!-- MAIN HEADER -->
        <?php echo $__env->make('frontend.mainheader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!-- /MAIN HEADER -->
    </header>
    <!-- /HEADER -->

    <!-- NAVIGATION -->
    <?php echo $__env->make('frontend.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- /NAVIGATION -->
    ...
    <!-- FOOTER -->
    <?php echo $__env->make('frontend.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- /FOOTER -->
...
<?php /**PATH C:\Users\Lenovo\Downloads\laravel-bengkel-v2\resources\views\layouts\front.blade.php ENDPATH**/ ?>