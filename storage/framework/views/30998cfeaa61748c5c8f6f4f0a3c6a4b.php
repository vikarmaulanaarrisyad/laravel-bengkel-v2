...
<?php $component = App\View\Components\Modal::resolve(['size' => 'modal-lg'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'modal-detail','data-backdrop' => 'static','data-keyboard' => 'false']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'pembelianDetail']); ?>
...
<?php endif; ?>
<?php /**PATH D:\WEB PROJEK\laravel-bengkel\resources\views/orders/detail.blade.php ENDPATH**/ ?>