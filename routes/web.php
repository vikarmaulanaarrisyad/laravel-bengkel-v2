...
use App\Http\Controllers\Konfigurasi\StokofflineController;
...
Route::group(
    ...
    function () {
        ...
        // Kompatibilitas route lama untuk regencies/kabupaten
    ...
    Route::get('/laporanpenjualan', [LaporanPenjualanController::class, 'index'])->name('laporanpenjualan.index');
        ...
        Route::put('/stokoffline/{id}', [StokofflineController::class, 'update'])->name('stokoffline.update');
        Route::get('/stokoffline/transaksi', [StokofflineController::class, 'transaksiForm'])->name('stokoffline.transaksiForm');
        Route::post('/stokoffline/transaksi', [StokofflineController::class, 'transaksi'])->name('stokoffline.transaksi');
...
Route::get('/api/rajaongkir/provinces', [RajaOngkirController::class, 'provinces']);
Route::get('/api/rajaongkir/cities', [RajaOngkirController::class, 'cities']);
Route::get('/api/rajaongkir/subdistricts', [RajaOngkirController::class, 'subdistricts']);

// --- PERBAIKAN DI SINI ---
// Mengubah 'getOngkir' menjadi 'getCost' agar sesuai dengan nama method di controller
