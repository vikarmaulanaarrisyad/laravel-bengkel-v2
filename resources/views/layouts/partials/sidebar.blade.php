    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-child-indent" data-widget="treeview"
                ...
                <li class="nav-item">
                    <a href="{{ route('laporanpenjualan.index') }}" class="nav-link">
                        <i class="nav-icon fas fa-file-alt"></i>
                        <p>Laporan Penjualan</p>
                    </a>
                </li>
                    <li class="nav-item">
                        <a href="{{ route('stokoffline.index') }}" class="nav-link">
                ...
                @endcan
                @can('StockOffline Index')
                    <li class="nav-item">
                        <a href="{{ route('stockoffline.index') }}" class="nav-link">
                            <i class="nav-icon fas fa-warehouse"></i>
                            <p>Stok Offline</p>
                        </a>
                    </li>
