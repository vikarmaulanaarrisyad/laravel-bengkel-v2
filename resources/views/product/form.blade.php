<x-modal data-backdrop="static" data-keyboard="false" size="modal-md">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                <label for="product_date">Tanggal <span class="text-danger">*</span></label>
                <input type="date" class="form-control" name="product_date" id="product_date">
            </div>
        </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="product_note" id="product_note" rows="2" placeholder="Tambahkan catatan jika perlu"></textarea>
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ori_kw" id="ori" value="Ori">
            <label class="form-check-label" for="ori">Ori</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ori_kw" id="kw" value="KW">
